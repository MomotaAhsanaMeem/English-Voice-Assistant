...
- en-US-AriaNeural (Female voice, US)
- en-US-GuyNeural (Male voice, US)
- en-GB-SoniaNeural (Female voice, UK)
- en-GB-RyanNeural (Male voice, UK)
- en-AU-NatashaNeural (Female voice, Australia)

    """
    
    def __init__(
        self,
        voice: str = "en-US-AriaNeural",  # Default Bangla voice
        rate: str = "+0%",
        volume: str = "+0%",
        pitch: str = "+0Hz",
    ):
        """
        Initialize Edge TTS with English voice.
