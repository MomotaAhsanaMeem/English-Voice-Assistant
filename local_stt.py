"""
Simplified Remote English Speech-to-Text using gradio_client library
...
class LocalEnglishSpeechSTT(stt.STT):
    """
    ...
    def __init__(
        ...
        logger.info(f"Initialized RemoteEnglishSpeechSTT with API: {self._api_url}")
    ...
    async def aclose(self):
        """Clean up resources"""
        logger.debug("Closing RemoteEnglishSpeechSTT")
        await super().aclose()
